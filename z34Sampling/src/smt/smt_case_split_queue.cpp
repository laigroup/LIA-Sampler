...
class act_case_split_queue : public case_split_queue {
   ...
   public:
    act_case_split_queue(context &ctx, smt_params &p) : m_context(ctx),
                                                        m_params(p),
...
class dact_case_split_queue : public act_case_split_queue {
   ...
   public:
    dact_case_split_queue(context &ctx, smt_params &p) : act_case_split_queue(ctx, p),
...
class cact_case_split_queue : public act_case_split_queue {
   ...
   public:
    cact_case_split_queue(context &ctx, smt_params &p) : act_case_split_queue(ctx, p),
...
class rel_case_split_queue : public case_split_queue {
   ...
   public:
    rel_case_split_queue(context &ctx, smt_params &p) : m_context(ctx),
                                                        m_params(p),
...
class rel_act_case_split_queue : public case_split_queue {
   ...
   public:
    rel_act_case_split_queue(context &ctx, smt_params &p) : m_context(ctx),
                                                            m_manager(ctx.get_manager()),
                                                            m_params(p),
                                                            m_head(0),
                                                            m_bs_num_bool_vars(UINT_MAX),
...
#define GOAL_STOP() \
    ...
    struct queue_entry {
        ...
        queue_entry(expr *e, unsigned gen) : m_expr(e),
                                             m_generation(gen),
                                             m_last_decided(-1) {}
    };
   ...
   public:
    rel_goal_case_split_queue(context &ctx, smt_params &p) : m_context(ctx),
                                                             m_params(p),
                                                             m_manager(ctx.get_manager()),
                                                             m_head(0),
                                                             m_bs_num_bool_vars(UINT_MAX),
...
class theory_aware_branching_queue : public case_split_queue {
   ...
   public:
    theory_aware_branching_queue(context &ctx, smt_params &p) : m_context(ctx),
                                                                m_params(p),
