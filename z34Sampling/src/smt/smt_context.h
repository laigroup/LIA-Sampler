...
namespace smt {
    ...
    protected:
        ...
        sampler::ls_sampler *       m_ls_sampler;
        ast_manager &               m;
...
#define INV_ACTIVITY_LIMIT 1e-100
    ...
    public:
        void print_clauses_vec(std::ostream& out, const std::vector<std::vector<int> >& vec);
        ...
        void expr_bool_var_map(sampler::ls_sampler *sampler);
