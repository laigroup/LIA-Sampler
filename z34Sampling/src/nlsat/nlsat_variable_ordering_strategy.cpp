    ...
    struct VOS_Var_Info_Collector::imp {
       ...
       struct univariate_reorder_lt {
            ...
            bool operator()(var x, var y) const {
                return m_info->m_num_uni[x] == m_info->m_num_uni[y] ? x < y : m_info->m_num_uni[x] > m_info->m_num_uni[y];
            }
        };
        ...
        struct root_reorder_lt {
            VOS_Var_Info_Collector::imp const * m_info;
            root_reorder_lt(VOS_Var_Info_Collector::imp const * info): m_info(info){}
            bool operator()(var x, var y) const {
