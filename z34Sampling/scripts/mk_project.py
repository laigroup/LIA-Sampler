...
def init_project_def():
    ...
    add_lib('sat', ['util','cadical', 'dd', 'grobner'])    
    ...
    add_lib('lia_ls', ['util'], 'smt/lia_ls')
    add_lib('nia_ls', [], 'smt/nia_ls')
    add_lib('nra_ls', [], 'smt/nra_ls')
    add_lib('sampler', ['util', 'lia_ls'], 'sampler') # my sampler
    add_lib('smt', ['bit_blaster', 'macros', 'normal_forms', 'cmd_context', 'proto_model', 'solver_assertions', 'lia_ls', 'nia_ls' ,'nra_ls' , 'sampler' , 
    ...
    add_exe('shell', ['api', 'sat', 'extra_cmds', 'opt', 'sampler'], exe_name='z3')
